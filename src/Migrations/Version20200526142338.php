 ...
 */
final class Version20200526142338 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E9E53E855E237E06 ON verbe_groupe (name)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_C3F17511426F9DDC ON word (kanji)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E9E53E855E237E06 ON verbe_groupe');
        $this->addSql('DROP INDEX UNIQ_C3F17511426F9DDC ON word');
    }
}
